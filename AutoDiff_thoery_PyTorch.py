...
#       + Calculate Loss: Mean Square Error, in this sample script.
...
#          - When Loss is calculated each Epoch (iteration), PyTorch uses these values to calculate derivative of loss
...
#           - Starts differentiating from the last node(operation) of the graph and
...
#                   then a corresponding increase or decrease would affect the value of the Loss more than an increase/decrease in other parameters.
